...
public class DialogueRunnerMockUI : Yarn.Unity.DialogueViewBase
{
    ...
    // The amount of time that this view will take before notifying that
    // the line has been delivered. If zero, lines are delivered immediately.
    public float simulatedLineDeliveryTime = 0;

    // The amount of time that this view will take before notifying that
    // the line has been dismissed. If zero, lines are dismissed
    // immediately.
    public float simulatedLineDismissalTime = 0;

    // If true, the line has been interrupted, and we should notify that
    // delivery is complete immediately.
    ...
    {        
        // Wait for an amount of time before calling the completion handler
    ...
    public override void DismissLine(Action onDismissalComplete) {
        // Signal that we're done "dismissing" the line after the correct
        // amount of time
